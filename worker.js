...
// --- Global upstream circuit breaker + edge caching (shared across callers/colos/IPs) ---
// Caching absorbs repeated queries; the breaker caps distinct-query pressure on the
// package registries so a flood cannot get Datakoot rate-limited by npm/PyPI/crates.
// Counts only origin hits (cache misses). Trips to an honest "briefly busy, retry".
// Fails open on any D1 problem.
let DK_QDB = null;
const DK_UP_LIMITS = [
  { host: "registry.npmjs.org", key: "npm", win: 10, limit: 100 },
  { host: "api.npmjs.org",      key: "npm", win: 10, limit: 100 },
  { host: "pypi.org",           key: "pypi", win: 10, limit: 100 },
  { host: "crates.io",          key: "crates", win: 10, limit: 100 },
  { host: "api.deps.dev",       key: "depsdev", win: 10, limit: 60 },
];
